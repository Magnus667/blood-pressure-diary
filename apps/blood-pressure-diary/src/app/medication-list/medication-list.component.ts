...
export class MedicationListComponent implements OnInit {
  displayedColumns: string[] = ['MedicineName', 'Dosage', 'Timestamp', 'actions'];

  private initialSort: Sort<Medication> = { property: 'Timestamp', order: 'DESC' };
...
@Component({
  ...
  template: `
    ...
    <mat-dialog-content class="mat-typography">
      Soll der Eintrag ({{data.Timestamp | date: 'dd.MM.YYYY HH:mm' }}) gelöscht werden?
    </mat-dialog-content>
