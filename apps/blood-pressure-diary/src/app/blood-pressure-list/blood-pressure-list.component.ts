...
@Component({
  selector: 'bpd-blood-pressure-list',
  templateUrl: './blood-pressure-list.component.html',
  styleUrls: ['./blood-pressure-list.component.scss']
})
export class BloodPressureListComponent implements OnInit, AfterViewInit, OnDestroy {
